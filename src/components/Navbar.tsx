        ...
        <nav className={cn(
            ...
            <div className="container mx-auto flex items-center justify-between px-4 md:px-6">
                ...
                <Link href="/" className="flex items-center gap-2 group shrink-0">
                    <img src="/icon.svg" alt="Resaleo" className="h-10 w-10 object-contain group-hover:rotate-12 transition-transform duration-300" />
                ...
                <form onSubmit={(e) => {
                ...
                }} className="hidden md:flex flex-1 max-w-4xl mx-8 relative">
                    <input
                        type="text"
                        name="query"
                    ...
                    <button type="submit" className="absolute right-1.5 top-1.5 bottom-1.5 bg-primary text-white rounded-full px-4 text-xs font-bold hover:bg-primary/90 transition-colors">
                        Search
                    </button>
                </form>
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    {user ? (
                        <div className="flex items-center gap-4">
                            ...
                            <Link href="/profile" className="flex items-center gap-2 p-1 hover:bg-gray-50 rounded-full transition-all border border-transparent hover:border-gray-200 pr-3">
            ...
            {isMenuOpen && (
                <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-gray-200 p-4 shadow-2xl animate-in slide-in-from-top-5 z-[60]">
                    <div className="space-y-4">
                        ...
                        {user ? (
                            <Link href="/profile" className="block w-full text-center py-3 font-semibold text-foreground bg-secondary rounded-xl" onClick={() => setIsMenuOpen(false)}>
                                My Profile
                            </Link>
                        ) : (
